...
<div id="instagram_plugin_instructions" style="display: none;">
	<h2>Setup Instructions</h2>
	
	<div class="instagram_setup_instructions">
		<div class="instagram_setup_img">
			<div class="instagram_setup_img_message">
				<div>
					Hover to view image.
				</div>
			</div>
			<img src="http://wordpress.ink361.com/static/images/help/image10.png">
		</div>
		<div class="instagram_setup_text">
			<p>
			...
			<a class="instagram_setup_button" href="widgets.php">
				Manage Widgets
			</a>
		</div>	
	</div>
...
<script>
	function displayInstagramSetupInstructions() {
		lightbox({
        content : jQuery('#instagram_plugin_instructions').html(),
        frameCls : '',
